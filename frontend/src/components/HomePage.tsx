...
const HomePage: React.FC = () => {
  ...
  return <div className="space-y-16">
      ...
      <section className="relative text-center py-12 md:py-16 bg-gradient-to-br from-green-50 via-blue-50 to-green-100 rounded-2xl overflow-hidden" aria-label="Hero Section">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-3 justify-center items-center mb-8" role="list" aria-label="Certifications and Ratings">
            <div className="bg-yellow-400 text-black px-4 py-2 rounded-full font-bold text-sm sm:text-base" role="listitem">
              4.9/5 Rating (98k+ Reviews)
            </div>
            <div className="bg-green-700 text-white px-4 py-2 rounded-full font-bold text-sm sm:text-base" role="listitem">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 px-4">
            <Button 
              size="lg" 
              className="relative bg-gradient-to-r from-green-600 via-green-700 to-green-800 hover:from-green-700 hover:via-green-800 hover:to-green-900 text-white px-8 py-6 text-lg sm:text-xl font-bold rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 overflow-hidden group w-full sm:w-auto" 
              onClick={handleGetQuoteClick}
              aria-label="Get a quote in a single click"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/20 to-orange-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative flex items-center justify-center gap-2 sm:gap-3">
                <span className="text-xl sm:text-2xl" aria-hidden="true">💡</span>
                <span>Get Quote in a Click</span>
                <div className="ml-2 px-2 py-1 bg-yellow-400 text-green-900 text-xs rounded-full font-bold animate-pulse hidden sm:block">
                  CLICK
                </div>
              </div>
            </Button>
            <Button 
              variant="outline" 
              size="lg" 
              className="border-2 border-gray-400 text-gray-700 hover:bg-gray-100 px-6 py-4 text-base sm:text-lg font-bold w-full sm:w-auto whitespace-normal h-auto" 
              onClick={() => navigate('/calculator')}
              aria-label="Discover your solar size today"
            >
              Discover Your Solar Size
            </Button>
          </div>
      ...
      <section className="py-12" id="select-plan-section">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          return <Card key={plan.id} className={`relative overflow-hidden cursor-pointer transform hover:scale-105 transition-all duration-300 bg-gradient-to-br ${plan.color} text-white border-0 shadow-2xl`} onClick={() => navigate('/select-plan')}>
                {/* Badge */}
