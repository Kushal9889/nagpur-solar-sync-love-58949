...
const BrandCarousel: React.FC = () => {
  const brands = [
    { name: 'Waaree', logo: '/uploads/waaree-logo.png' },
    { name: 'Adani Solar', logo: '/uploads/adani-logo.png' },
    { name: 'Tata Solar', logo: '/uploads/tata-logo.png' },
    { name: 'Luminous', logo: '/uploads/luminous-logo.png' },
    { name: 'Vikram Solar', logo: '/uploads/vikram-logo.png' },
    { name: 'Panasonic', logo: '/uploads/panasonic-logo.png' },
    { name: 'LONGi', logo: '/uploads/longi-logo.png' },
    { name: 'JA Solar', logo: '/uploads/ja-solar-logo.png' }
  ];
