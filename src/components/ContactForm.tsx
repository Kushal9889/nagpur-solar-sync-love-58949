  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Contact SuryaSpark</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-600">support@suryaspark.com</div>
                </div>
              </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Why Choose SuryaSpark?</CardTitle>
            </CardHeader>
            <CardContent>
