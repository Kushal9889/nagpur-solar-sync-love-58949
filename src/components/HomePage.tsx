...
const HomePage: React.FC<HomePageProps> = ({
  ...
  return <div className="space-y-16">
      ...
      <section className="relative text-center py-16 bg-gradient-to-br from-green-50 via-blue-50 to-green-100 rounded-2xl overflow-hidden" aria-label="Hero Section">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8" role="list" aria-label="Certifications and Ratings">
            <div className="bg-yellow-400 text-black px-6 py-2 rounded-full font-bold text-lg" role="listitem">
              4.9/5 Rating (98,000+ Reviews)
            </div>
            <div className="bg-green-700 text-white px-6 py-2 rounded-full font-bold" role="listitem">
              98,000+ Happy Families Saved upto 1Lakh /Yr Each!
            </div>
            <div className="bg-blue-600 text-white px-6 py-2 rounded-full font-bold" role="listitem">
              🏆 MNRE Certified
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button 
              size="lg" 
              className="relative bg-gradient-to-r from-green-600 via-green-700 to-green-800 hover:from-green-700 hover:via-green-800 hover:to-green-900 text-white px-12 py-6 text-xl font-bold rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-300 overflow-hidden group" 
