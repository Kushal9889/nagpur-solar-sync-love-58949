  ...
  const plans = [
    {
      ...
      image: '/lovable-uploads/basic-solar.png',
      features: [
    ...
    },
    {
      ...
      image: '/lovable-uploads/standard-solar.png',
      features: [
    ...
    },
    {
      ...
      image: '/lovable-uploads/premium-solar.png',
      features: [
        ...
        <div className="container mx-auto">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-2xl font-bold">SuryaSpark</h1>
