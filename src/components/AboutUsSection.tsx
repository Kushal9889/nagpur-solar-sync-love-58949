      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            About <span className="text-green-600">SuryaSpark</span>
          </h1>
...
☀️ Our Promise: Solar made simple, affordable, and regret-free — for a lifetime. </p>
        ...
        <Card className="mb-16 shadow-xl">
          <CardHeader className="bg-gradient-to-r from-green-600 to-blue-600 text-white">
            <CardTitle className="text-3xl text-center">Why Choose SuryaSpark?</CardTitle>
          ...
          <CardContent className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-gray-600">support@suryaspark.com</p>
              </div>
              <div>
        ...
        <Card className="bg-gradient-to-r from-green-600 to-blue-600 text-white shadow-2xl">
          <CardContent className="p-12 text-center">
            ...
            <Button size="lg" onClick={() => onNavigate('booking')} className="bg-green-800 hover:bg-yellow-400 hover:text-green-800 text-yellow-400 font-bold text-lg px-12 py-4 rounded-full shadow-lg transform hover:scale-110 transition-all duration-300 animate-slow-pulse">
