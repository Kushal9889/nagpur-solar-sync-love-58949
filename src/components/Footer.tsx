        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-3xl font-bold text-white">SuryaSpark</span>
            </div>
              ...
              <div className="bg-green-700 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-300">support@suryaspark.com</span>
                  </div>
                  <div className="flex items-center space-x-2">
          ...
          <div className="space-y-4 animate-fade-in" style={{animationDelay: '0.6s'}}>
            ...
            <div className="space-y-3">
              <p className="text-sm text-gray-300">Share SuryaSpark with friends:</p>
              <div className="flex space-x-3">
                ...
                <button
                  onClick={() => navigator.share?.({ title: 'SuryaSpark', url: window.location.href })}
        ...
        <div className="border-t border-green-600 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-300 text-center md:text-left">
              © 2024 SuryaSpark. All rights reserved. | 
