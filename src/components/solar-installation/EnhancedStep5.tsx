          ...
          <div className="space-y-6">
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">One-time installation cost</div>
              </div>
            </div>
