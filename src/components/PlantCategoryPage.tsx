...
const PlantCategoryPage: React.FC<PlantCategoryPageProps> = ({ onBack, onNext }) => {
  ...
  const categories = [
    {
      ...
      image: '/lovable-uploads/ground-mounted.png'
    },
    {
      id: 'standard',
      name: 'Standard',
      ...
      image: '/lovable-uploads/elevated-structure.png'
    },
    {
      id: 'premium',
      name: 'Premium',
      ...
      image: '/lovable-uploads/elevated-walkway.png'
    }
  ];
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">SuryaSpark</p>
              </div>
            </div>
          </div>
