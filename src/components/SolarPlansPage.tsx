...
interface SolarPlansPageProps {
  onNavigate: (section: string) => void;
}

const SolarPlansPage: React.FC<SolarPlansPageProps> = ({ onNavigate }) => {
            ...
            <Card className="bg-gradient-to-r from-[#FFC107] to-[#FF6200] text-black shadow-2xl border-0 max-w-4xl mx-auto">
              <CardContent className="p-8">
                ...
                <blockquote className="text-xl italic mb-4">
                  "My family saves ₹15,000/year with SuryaSpark! Best decision we ever made for our home."
                </blockquote>
